...
config :balados_sync_web, BaladosSyncWeb.Endpoint,
  ...
  watchers: [
    ...
    typescript: {FS, :cmd, ["npx", ~w(tsc --noEmit --watch --preserveWatchOutput --pretty), [cd: Path.expand("../apps/balados_sync_web/assets", __DIR__), :stream]]}
  ]
...
config :balados_sync_web, BaladosSyncWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/balados_sync_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :balados_sync_web, dev_routes: true
