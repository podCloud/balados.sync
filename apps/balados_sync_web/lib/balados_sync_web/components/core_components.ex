defmodule BaladosSyncWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "bg-blue-50 text-blue-800 ring-blue-500 fill-emerald-900",
        @kind == :error && "bg-rose-50 text-rose-900 shadow-md ring-rose-500 fill-rose-900"
      ]}
      {@rest}
    >
      <p :if={@title} class="flex items-center gap-1.5 text-sm font-semibold leading-6">
        <.icon :if={@kind == :success} name="hero-checkmark-circle-mini" class="h-4 w-4" />
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm text-zinc-600">
                    Your activity is completely hidden. Not shared publicly or in discovery.
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm text-zinc-600">
                    Contributes to podcast popularity but without your identity.
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm text-zinc-600">
                    Your activity is visible in discovery and contributes to recommendations.
                  </p>
                </div>
              </div>
            </button>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BaladosSyncWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BaladosSyncWeb.Gettext, "errors", msg, opts)
    end
  end
