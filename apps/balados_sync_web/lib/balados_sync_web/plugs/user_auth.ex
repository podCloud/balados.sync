defmodule BaladosSyncWeb.Plugs.UserAuth do
  @moduledoc """
  Plugs for handling user authentication via Phoenix sessions.
  """

  use BaladosSyncWeb, :verified_routes
  ...
  # the token expiry itself in PlayToken.
  @max_age 60 * 60 * 24 * 60
  ...
  def log_out_user(conn) do
    if live_socket_id = get_session(conn, :live_socket_id) do
      BaladosSyncWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
